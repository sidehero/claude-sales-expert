...
Claude Sales Expert is a **Tauri 2 desktop application** for B2B lead research and qualification. It uses Claude CLI as an AI backend for company/person research, scoring, and conversation generation.
...
Location: `~/.local/share/claude-sales-expert/data.db`
